        ...
        <Dialog.Root>
            ...
            <Dialog.Portal>
                ...
                <Dialog.Content className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white p-6 rounded-lg shadow-lg max-w-3xl max-h-[90vh] overflow-y-auto z-50">
                    <Dialog.Title className="text-xl font-semibold mb-4">Mentions légales de Workyt</Dialog.Title>
                    <Dialog.Description className="space-y-4">
                        <p>
                            Présentation du site: En vertu de l’article 6 de la loi n° 2004-575 du 21 juin 2004 pour la confiance dans l’économie numérique, il est précisé aux utilisateurs du site www.workyt.fr l’identité des différents intervenants dans le cadre de sa réalisation et de son suivi :
                        </p>
                        <p>
                        ...
                        <p>
                            ...
                            <br />
                            Hébergeur : VIDON (Shiftek Hosting) – 6 RUE AR PRAT 29760 PENMARCH
                        </p>
                        ...
                        <h2>Contenu intégré d’autres sites Web</h2>
                        <p>
