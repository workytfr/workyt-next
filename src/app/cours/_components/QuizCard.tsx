        ...
        >
            ...
            <CardHeader className="pb-4 pt-6">
                <div className="flex items-start justify-between">
                    <CardTitle className="text-lg font-bold text-gray-800 group-hover:text-gray-900 transition-colors duration-200 flex items-center gap-2">
                        {quiz.completed ? (
                ...
                {session?.user ? (
                    ...
                    <div className="mt-4 p-3 bg-gray-50 rounded-lg border border-gray-200">
                        <div className="flex items-center gap-2 text-gray-600">
                            ...
                            <span className="text-sm font-medium">Connectez-vous pour participer</span>
                        </div>
                    </div>
                )}
            </CardContent>
